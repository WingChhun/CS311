...
{ 
 ...
 public: // prototypes to be used by the client
  ...
  //PURPOSE: The purpose of this routine is to check if the Stack is empty.
  bool isEmpty();
  //PURPOSE: This function will check if the Stack is full
  bool isFull();
  //PURPOSE: This function will display the contents of the stack
  void displayAll();
  //PURPOSE: **
  void clearIt();
